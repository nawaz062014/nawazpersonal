sap.ui.define([
	...
	"sap/ui/Device",
	"sncReq/model/models",
	"sncReq/controller/ListSelector",
	"sncReq/controller/ErrorHandler",
	"sncReq/controller/DataHelper",
	"sncReq/model/formatter",
	"sncReq/model/grouper"
], function (UIComponent, Device, models, ListSelector, ErrorHandler, DataHelper) {
	"use strict";

	return UIComponent.extend("sncReq.Component", {

		metadata: {
			includes: ["CSS/style.css"],
			"version": "1.0.0",
			"rootView": {
				"viewName": "sncReq.view.App",
				"type": "XML",
				"id": "app"
			},
			"dependencies": {
			...
			"config": {
				"i18nBundle": "sncReq.i18n.i18n",
				"serviceUrl": "/sap/opu/odata/sap/ZGW_HR_SANC_REQ_SRV/",
				"icon": "",
				"favIcon": "",
				"phone": "",
				"phone@2": "",
			...
			"routing": {
				...
				"routes": [{
					...
					// "pattern": "SancreqSet/{objectId}",
					"pattern": "SancreqSet/{objectId}",
					"name": "object",
					"target": ["master", "object"]
				}, {
					"pattern": "CreateSncReq/{type}",
					"name": "createSncReq",
					"target": ["createSncReq"]
				}, {
		...
		init: function () {
			...
			var oModel = models.createODataModel({
				...
				config: {
					json: true, //adding this property so that data is fetched in JSON always
					metadataUrlParams: {
			...
			this._oDataHelper = new DataHelper(this);
