sap.ui.define([
	...
	return BaseObject.extend("sncReq.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias sncReq.model.ListSelector
		 */
		 ...
		 * @return {sncReq.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
