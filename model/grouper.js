sap.ui.define([], function() {
	...
	return {
		...
		/**
		 * Grouping function to group the master list by Totleavedays
		 * @public
		 * @param {object} oContext the current list item context
		 * @returns {object} an object with the Totleavedays as key and a text for the group headers
		 */
		Totleavedays: function(oContext) {
			var iPrice = oContext.getProperty("Totleavedays"),
				sKey,
				sText,
